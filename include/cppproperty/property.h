...
template<typename Owner, typename T, auto get>
concept nobacking_property_getter = get == 0 || requires(Owner& o) {
    { get(o) } -> std::convertible_to<T>;
};

template<typename Owner, typename T, auto set>
concept nobacking_property_setter = set == 0 || requires(Owner& o, const T& v) {
    { set(o, v) };
};

template<typename Owner, typename T, auto move>
concept nobacking_property_mover = move == 0 || requires(Owner& o, T&& v) {
    { move(o, std::move(v)) };
};

template<typename Owner, typename T, auto const_get>
concept nobacking_property_const_getter = const_get == 0 || requires(const Owner& o) {
    { const_get(o) } -> std::convertible_to<T>;
};
...
template<typename Owner, typename T, typename TReal, auto get, auto set, auto const_get, auto move>
concept nobacking_property_methods = not std::is_same_v<Owner, void>
                                    && std::is_same_v<TReal, void>
                                    && nobacking_property_getter<Owner, T, get>
                                    && nobacking_property_setter<Owner, T, set>
                                    && nobacking_property_const_getter<Owner, T, const_get>
                                    && nobacking_property_mover<Owner, T, move>;
...
template<typename Owner, typename T, typename TReal = T, auto get = nullptr,
    ...
    requires ((std::is_same_v<Owner, void> && static_property_methods<T, TReal, get, set, const_get, move>)
        ...
        || nobacking_property_methods<Owner, T, TReal, get, set, const_get, move>)
struct property;
...
struct property<Owner, T, T,  get, set, const_get, move>{
    ...
    constexpr property(const property& other) = delete;
    constexpr property(property&& other) noexcept = delete;
...
template<typename Owner, typename T, auto get, auto set, auto const_get, auto move>
requires nobacking_property_methods<Owner, T, void, get, set, const_get, move>
struct property<Owner, T, void,  get, set, const_get, move>{
    constexpr property(Owner& owner) : _owner(owner) {}
    constexpr property(const property& other) = delete;
    constexpr property(property&& other) = delete;
    property& operator=(const property& other) = delete;
    property& operator=(property&& other) = delete;
